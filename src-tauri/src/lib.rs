...
pub fn run(
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::export::export_code,
            commands::export::export_tokens,
            commands::export::export_icon_font,
            ...
            commands::packs::import_icon_pack,
            commands::packs::list_icon_packs,
            commands::packs::list_pack_icons,
            commands::packs::load_pack_icon,
            commands::packs::search_pack_icons,
            commands::packs::add_pack_icon_to_canvas,
            commands::packs::remove_icon_pack,
            commands::ai_commands::generate_icon,
            commands::ai_commands::generate_icon_set,
            commands::ai_commands::ai_remove_background,
            commands::ai_commands::configure_ai,
            commands::ai_commands::get_ai_config,
            commands::variant_commands::create_variant,
            commands::variant_commands::delete_variant,
            commands::variant_commands::preview_variant,
            commands::variant_commands::export_variant,
            commands::variant_commands::export_all_variants,
            commands::variant_commands::list_variants,
            commands::variant_commands::list_preset_rules,
            commands::variant_commands::generate_all_presets,
            commands::export::export_overlay_svg,
            commands::export::quick_export,
            commands::elements::fit_element_to_canvas,
            commands::elements::add_image_from_data,
            commands::elements::add_path_from_svg,
            commands::elements::set_element_overlay,
            commands::elements::remove_element_overlay,
            commands::elements::batch_apply_overlay,
            commands::elements::batch_remove_overlay,
            commands::theme_preset_commands::list_theme_presets,
            commands::theme_preset_commands::apply_theme_preset,
            commands::theme_preset_commands::save_custom_theme_preset,
            commands::export::get_favicon_html_snippet,
            commands::export::export_pwa_icons,
            commands::export::export_all_platforms,
            commands::export::export_sprite_sheet,
            commands::variant_commands::generate_weight_variants,
            commands::analysis::fix_consistency,
        ])
