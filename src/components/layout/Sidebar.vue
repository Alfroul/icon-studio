...
const panels: Record<string, ReturnType<typeof defineAsyncComponent>> = {
  ...
  preview: defineAsyncComponent(() => import("@/components/preview/DevicePreview.vue")),
  ...
  variants: defineAsyncComponent(() => import("@/components/variants/VariantsPanel.vue")),
  ai: defineAsyncComponent(() => import("@/components/ai/AiPanel.vue")),
